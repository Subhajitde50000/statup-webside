...
import { Briefcase, Phone, Mail, ArrowLeft, Loader2 } from 'lucide-react';
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 max-w-md w-full">
              ...
              <div className="flex gap-2 justify-center mb-4">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-200 rounded-xl focus:border-emerald-600 focus:outline-none transition-colors"
                  />
                ))}
              </div>
              <button
        ...
        <div className="mt-6 pt-6 border-t border-gray-200 text-center">
          <p className="text-sm text-gray-600">
            ...
            <Link href="/register/professional" className="text-emerald-600 hover:underline font-medium">
