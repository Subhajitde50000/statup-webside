...
import { Bell, Calendar, Clock, AlertCircle, Loader2, Ban } from 'lucide-react';
    ...
    const checkAuth = async () => {
      try {
        ...
        if (currentUser.is_suspended) {
          setIsSuspended(true);
          setSuspensionReason(currentUser.suspension_reason || 'No reason provided');
          setLoading(false);
          return;
        }
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-red-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-2xl shadow-xl p-8 text-center">
          ...
          <p className="text-gray-600 mb-4">
            Your professional account has been suspended by the management team.
          </p>
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6">
            <p className="text-sm font-semibold text-red-800 mb-1">Suspension Reason:</p>
          ...
          <div className="flex gap-3">
            ...
            <button 
              onClick={() => {
                window.location.href = 'mailto:support@electronics.com';
              }}
