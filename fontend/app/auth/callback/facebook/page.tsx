  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F4F7FB] via-white to-[#E8F4F8] flex items-center justify-center">
      <div className="bg-white rounded-3xl shadow-2xl p-8 md:p-12 max-w-md w-full text-center">
        {status === 'loading' && (
          <>
            <div className="bg-gradient-to-r from-[#1877F2] to-[#166FE5] w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
        ...
        {status === 'error' && (
          <>
            ...
            <button
              ...
              className="bg-gradient-to-r from-[#1877F2] to-[#166FE5] text-white px-6 py-3 rounded-xl font-semibold hover:shadow-lg transition-all"
            >
              Try Again
            </button>
          </>
