...
export default function SearchResults() {
  ...
  const [allprofessional_views] = useState([
    {
      id: 1,
      name: 'Rahul Das',
      profession: 'Electrician',
      photo: 'https://ui-avatars.com/api/?name=Rahul+Das&size=80&background=1A73E8&color=fff&bold=true',
      rating: 4.8,
      reviews: 320,
      pricePerHour: 299,
      inspectionFee: 149,
      distance: 1.2,
      skills: ['Wiring', 'Switchboard', 'Light fitting', 'Fan repair'],
      jobsCompleted: 1450,
      verified: true,
      availability: 'Available now',
      responseTime: '10 mins',
      experience: 8,
      description: 'Expert electrician with 8 years of experience in residential and commercial electrical work.'
    },
    {
      id: 2,
      name: 'Amit Kumar',
      profession: 'Electrician',
      photo: 'https://ui-avatars.com/api/?name=Amit+Kumar&size=80&background=6366F1&color=fff&bold=true',
      rating: 4.9,
      reviews: 450,
      pricePerHour: 349,
      inspectionFee: 199,
      distance: 2.5,
      skills: ['Emergency Fixing', 'Appliance Repair', 'Wiring Check', 'Panel Installation'],
      jobsCompleted: 2100,
      verified: true,
      availability: 'Available today',
      responseTime: '15 mins',
      experience: 12,
      description: 'Specialized in emergency electrical repairs and smart home installations.'
    },
    {
      id: 3,
      name: 'Suresh Sharma',
      profession: 'Electrician',
      photo: 'https://ui-avatars.com/api/?name=Suresh+Sharma&size=80&background=8B5CF6&color=fff&bold=true',
      rating: 4.7,
      reviews: 280,
      pricePerHour: 249,
      inspectionFee: 99,
      distance: 3.8,
      skills: ['Panel Repair', 'Cable Installation', 'Smart Home Setup'],
      jobsCompleted: 890,
      verified: true,
      availability: 'Available this week',
      responseTime: '30 mins',
      experience: 6,
      description: 'Affordable and reliable service for all types of electrical work.'
    },
    {
      id: 4,
      name: 'Vikash Singh',
      profession: 'Electrician',
      photo: 'https://ui-avatars.com/api/?name=Vikash+Singh&size=80&background=EC4899&color=fff&bold=true',
      rating: 4.6,
      reviews: 195,
      pricePerHour: 199,
      inspectionFee: 79,
      ...
      experience: 4,
      description: 'Fast and efficient electrical services at competitive rates.'
    },
    {
      id: 5,
      name: 'Rajesh Gupta',
      profession: 'Electrician',
      photo: 'https://ui-avatars.com/api/?name=Rajesh+Gupta&size=80&background=F59E0B&color=fff&bold=true',
      rating: 4.9,
      reviews: 580,
      pricePerHour: 399,
      inspectionFee: 249,
      distance: 5.1,
      skills: ['Industrial Wiring', 'Three Phase', 'Generator Setup', 'Solar Installation'],
      jobsCompleted: 3200,
      verified: true,
      availability: 'Available now',
      responseTime: '5 mins',
      experience: 15,
      description: 'Premium electrical services with expertise in industrial and commercial projects.'
    },
    {
      id: 6,
      name: 'Manoj Yadav',
      profession: 'Electrician',
      photo: 'https://ui-avatars.com/api/?name=Manoj+Yadav&size=80&background=10B981&color=fff&bold=true',
      rating: 4.5,
      reviews: 160,
      pricePerHour: 229,
      inspectionFee: 99,
      distance: 6.3,
      skills: ['Home Wiring', 'Lighting', 'Appliance Fix'],
      jobsCompleted: 420,
      verified: true,
      availability: 'Available today',
      responseTime: '25 mins',
      experience: 5,
      description: 'Specializing in residential electrical services and maintenance.'
    }
  ]);
